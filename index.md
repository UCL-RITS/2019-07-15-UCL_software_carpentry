...
humandate: "Jul 15-16, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2019-07-16   # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Roland Guichard", "Mosè Giordano", "Tim Spain", "Roma Klapaukh"]   # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Kenan Direk", "Mian Asbat Ahmad", "Tom Couch", "Matthew Gillman", "Jeremy Stein"]       # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: "https://pad.carpentries.org/2019-07-15-UCL"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: "64729654138"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
